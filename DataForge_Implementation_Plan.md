...
| Phase 6 — Alerting | In Progress | Trust-drop + drift-high alerts, dedup, alerts API/UI + acknowledgement flow added | Tag `v1.4-alerting-hooks` + latest commits |
...
2. Add/verify alert summary and acknowledgement endpoint usage in production dashboard checks.
